...
public class StringDemo5 {
	public static void main(String[]args) {
		String name="Vincent,Jo,Anita,Howerd,Alen,Rose,Bob";
		
		System.out.printf("原始資料: %s%n%n", name);
		
		System.out.printf("===題目1:人名統計===");
	...
	System.out.printf("最長: %-7s(%d字)%n", longest, longest.length());
	System.out.printf("最短: %-7s(%d字)%n", shortest, shortest.length());
